...
var relayCommonTransforms = [require('./RelayConnectionTransform').transform, require('./RelayViewerHandleTransform').transform, require('./RelayRelayDirectiveTransform').transform, require('./RelayMaskTransform').transform, require('./RelayDeferrableFragmentTransform').transformOperations, require('./RelayGenerateIDFieldTransform').transform];
...
var relayQueryTransforms = [require('./RelayDeferrableFragmentTransform').transformSpreads, require('./RelayApplyFragmentArgumentTransform').transform, SkipClientFieldTransform.transform, SkipUnreachableNodeTransform.transform];
