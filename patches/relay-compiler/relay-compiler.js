...
/***/ (function(module, exports, __webpack_require__) {
	...
	var RelayJSModuleParser = __webpack_require__(64)(__webpack_require__(48).find);

	module.exports = {
	  ConsoleReporter: ConsoleReporter,
	  Parser: __webpack_require__(21),
	  CodeGenerator: __webpack_require__(31),
	  ...
	  compileRelayArtifacts: __webpack_require__(40),
	  formatGeneratedModule: __webpack_require__(75),
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ASTConvert: __webpack_require__(44),
	  CodegenDirectory: __webpack_require__(18),
	  CodegenRunner: __webpack_require__(45),
	  CodegenWatcher: __webpack_require__(19),
	  CompilerContext: __webpack_require__(24),
	  ConsoleReporter: __webpack_require__(50),
	  DotGraphQLParser: __webpack_require__(46),
	  ASTCache: __webpack_require__(27),
	  IRTransformer: __webpack_require__(11),
	  IRVisitor: __webpack_require__(26),
	  MultiReporter: __webpack_require__(51),
	  Parser: __webpack_require__(52),
	  Printer: __webpack_require__(25),
	  Profiler: __webpack_require__(6),
	  SchemaUtils: __webpack_require__(13),
	  SourceControlMercurial: SourceControlMercurial,
	  Validator: __webpack_require__(30),
	  WatchmanClient: __webpack_require__(20),
	  filterContextForNode: __webpack_require__(74),
	  getIdentifierForArgumentValue: __webpack_require__(76),
	  getLiteralArgumentValues: __webpack_require__(77),
	  isEquivalentType: __webpack_require__(80),
	  nullthrows: __webpack_require__(14),

	  FilterDirectivesTransform: __webpack_require__(47),
	  FlattenTransform: __webpack_require__(49),
	  InlineFragmentsTransform: __webpack_require__(53),
	  SkipClientFieldTransform: __webpack_require__(66),
	  SkipRedundantNodesTransform: __webpack_require__(67),
	  SkipUnreachableNodeTransform: __webpack_require__(68),
	  StripUnusedVariablesTransform: __webpack_require__(70)
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function getRawType(type) {
	  return __webpack_require__(14)(getNamedType(type));
	}
	...
	var CodegenDirectory = function () {
	  function CodegenDirectory(dir) {
	    ...
	    if (__webpack_require__(2).existsSync(dir)) {
	      ...
	      var dirs = [dir];
	      var parent = __webpack_require__(5).dirname(dir);
	      while (!__webpack_require__(2).existsSync(parent)) {
	        dirs.unshift(parent);
	        parent = __webpack_require__(5).dirname(parent);
	      }
	      dirs.forEach(function (d) {
	        return __webpack_require__(2).mkdirSync(d);
	      });
	    }
	    this._files = new Set();
	    this.changes = {
	  ...
	  CodegenDirectory.printChanges = function printChanges(changes, options) {
	    __webpack_require__(6).run('CodegenDirectory.printChanges', function () {
	      var output = [];
	  ...
	  CodegenDirectory.prototype.writeFile = function writeFile(filename, content) {
	    ...
	    __webpack_require__(6).run('CodegenDirectory.writeFile', function () {
	      _this._addGenerated(filename);
	      var filePath = __webpack_require__(5).join(_this._dir, filename);
	      if (__webpack_require__(2).existsSync(filePath)) {
	  ...
	  CodegenDirectory.prototype.deleteExtraFiles = function deleteExtraFiles() {
	    ...
	    __webpack_require__(6).run('CodegenDirectory.deleteExtraFiles', function () {
	      __webpack_require__(2).readdirSync(_this2._dir).forEach(function (actualFile) {
	        if (!_this2._files.has(actualFile) && !/^\./.test(actualFile)) {
	          if (!_this2.onlyValidate) {
	            try {
	              __webpack_require__(2).unlinkSync(__webpack_require__(5).join(_this2._dir, actualFile));
	            } catch (e) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	let queryFiles = (() => {
	  var _ref3 = (0, _asyncToGenerator3.default)(function* (baseDir, expression, filter) {
	    return yield __webpack_require__(6).waitFor('Watchman:query', (0, _asyncToGenerator3.default)(function* () {
	      var client = new (__webpack_require__(20))();
	...
	let watch = (() => {
	  var _ref7 = (0, _asyncToGenerator3.default)(function* (baseDir, expression, callback) {
	    return yield __webpack_require__(6).waitFor('Watchman:subscribe', (0, _asyncToGenerator3.default)(function* () {
	      var client = new (__webpack_require__(20))();
	...
	function hashFile(filename) {
	  ...
	  return __webpack_require__(22).createHash('sha1').update(content).digest('hex');
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var GraphQLWatchmanClient = function () {
	  ...
	  function GraphQLWatchmanClient() {
	    ...
	    this._client = new (__webpack_require__(90).Client)();
	  }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _possibleConstructorReturn3 = _interopRequireDefault(__webpack_require__(87));

	var _inherits3 = _interopRequireDefault(__webpack_require__(86));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var GraphQLCompilerContext = function () {
	  ...
	  GraphQLCompilerContext.prototype.applyTransforms = function applyTransforms(transforms, reporter) {
	    ...
	    return __webpack_require__(6).run('applyTransforms', function () {
	  ...
	  GraphQLCompilerContext.prototype.applyTransform = function applyTransform(transform, reporter) {
	    ...
	    if (!transformed) {
	      ...
	      transformed = __webpack_require__(6).instrument(transform)(this);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ASTCache = function () {
	  function ASTCache(config) {
	    ...
	    this._parse = __webpack_require__(6).instrument(config.parse, 'ASTCache.parseFn');
	  }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function validateOrThrow(document, schema, rules) {
	  ...
	  if (validationErrors && validationErrors.length > 0) {
	    ...
	    var error = new Error(__webpack_require__(17).format('You supplied a GraphQL document with validation errors:\n%s', errorMessages.join('\n')));
	...
	module.exports = {
	  ...
	  validate: __webpack_require__(6).instrument(validateOrThrow, 'GraphQLValidator.validate')
	};
	  ...
	  leave: {
	    ...
	    Literal: function Literal(node, key, parent) {
	      return {
	        kind: 'Literal',
	        name: parent.name,
	        value: __webpack_require__(84)(node.value),
	        type: parent.type ? parent.type.toString() : null
	      };
	    },
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function createArgumentDefinitions(context, spreadUsesWithin, fragment) {
	  ...
	  while (nodesToVisit.length !== 0) {
	    var spreadUses = __webpack_require__(23)(spreadUsesWithin.get(nodesToVisit.pop()));
	...
	function getDeferrableSpreadUses(context, spreadUsesWithin, node) {
	  ...
	  if (!deferrableSpreadUses) {
	    ...
	    try {
	      for (var _iterator3 = __webpack_require__(23)(spreadUsesWithin.get(node))[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
	...
	function compileRelayArtifacts(context, transforms, reporter) {
	  return Profiler.run('GraphQLCompiler.compile', function () {
	    ...
	    return fragmentContext.documents().map(function (node) {
	      return __webpack_require__(31).generate(node.kind === 'Fragment' ? node : {
	        kind: 'Batch',
	        ...
	        requests: __webpack_require__(83)(printContext, codeGenContext, node.name)
	      });
	    });
	  });
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function convertASTDocuments(schema, documents, validationRules, transform) {
	  return __webpack_require__(6).run('ASTConvert.convertASTDocuments', function () {
	...
	function convertASTDocumentsWithBase(schema, baseDocuments, documents, validationRules, transform) {
	  return __webpack_require__(6).run('ASTConvert.convertASTDocumentsWithBase', function () {
	...
	function convertASTDefinitions(schema, definitions, validationRules, transform) {
	  ...
	  __webpack_require__(30).validate(validationAST, schema, validationRules);
	...
	function transformASTSchema(schema, schemaExtensions) {
	  return __webpack_require__(6).run('ASTConvert.transformASTSchema', function () {
	...
	function extendASTSchema(baseSchema, documents) {
	  return __webpack_require__(6).run('ASTConvert.extendASTSchema', function () {
	...
	var CodegenRunner = function () {
	  ...
	  CodegenRunner.prototype.compile = (() => {
	    var _ref2 = (0, _asyncToGenerator3.default)(function* (writerName) {
	      ...
	      yield __webpack_require__(6).asyncContext('CodegenRunner:parseEverything', function () {
	  ...
	  CodegenRunner.prototype.getDirtyWriters = function getDirtyWriters(filePaths) {
	    ...
	    return __webpack_require__(6).asyncContext('CodegenRunner:getDirtyWriters', (0, _asyncToGenerator3.default)(function* () {
	      ...
	      yield Promise.all(Object.keys(_this3.parserConfigs).map(function (parserConfigName) {
	        return __webpack_require__(6).waitFor('Watchman:query', (0, _asyncToGenerator3.default)(function* () {
	          var client = new (__webpack_require__(20))();
	  ...
	  CodegenRunner.prototype.parseEverything = (() => {
	    var _ref5 = (0, _asyncToGenerator3.default)(function* (parserName) {
	      ...
	      if (parserConfig.watchmanExpression) {
	        files = yield __webpack_require__(19).queryFiles(parserConfig.baseDir, parserConfig.watchmanExpression, filter);
	      } else if (parserConfig.filepaths) {
	        files = yield __webpack_require__(19).queryFilepaths(parserConfig.baseDir, parserConfig.filepaths, filter);
	      } else {
	  ...
	  CodegenRunner.prototype.parseFileChanges = function parseFileChanges(parserName, files) {
	    ...
	    return __webpack_require__(6).run('CodegenRunner.parseFileChanges', function () {
	  ...
	  CodegenRunner.prototype.write = function write(writerName) {
	    ...
	    return __webpack_require__(6).asyncContext('CodegenRunner.write', (0, _asyncToGenerator3.default)(function* () {
	      try {
	        ...
	        var _schema = __webpack_require__(6).run('getSchema', function () {
	        ...
	        var combinedChanges = __webpack_require__(18).combineChanges(Array.from(outputDirectories.values()));
	        __webpack_require__(18).printChanges(combinedChanges, {
	          onlyValidate: _this5.onlyValidate
	        });
	        return __webpack_require__(18).hasChanges(combinedChanges) ? 'HAS_CHANGES' : 'NO_CHANGES';
	      } catch (e) {
	  ...
	  CodegenRunner.prototype.watch = (() => {
	    var _ref8 = (0, _asyncToGenerator3.default)(function* (parserName) {
	      ...
	      yield __webpack_require__(19).watchCompile(parserConfig.baseDir, parserConfig.watchmanExpression, parserConfig.getFileFilter ? parserConfig.getFileFilter(parserConfig.baseDir) : anyFileFilter, (() => {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function parseFile(baseDir, file) {
	  var text = __webpack_require__(2).readFileSync(__webpack_require__(5).join(baseDir, file.relPath), 'utf8');
	...
	exports.getParser = function getParser(baseDir) {
	  return new (__webpack_require__(27))({ baseDir: baseDir, parse: parseFile });
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function find(text) {
	  var result = [];
	  var ast = __webpack_require__(88).parse(text, BABYLON_OPTIONS);
	...
	function invariant(condition, msg) {
	  if (!condition) {
	    ...
	    throw new Error(__webpack_require__(17).format.apply(__webpack_require__(17), [msg].concat(args)));
	  }
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var getRawType = __webpack_require__(13).getRawType,
	    isAbstractType = __webpack_require__(13).isAbstractType;
	...
	function areEqualFields(thisField, thatField) {
	  return thisField.kind === thatField.kind && thisField.name === thatField.name && thisField.alias === thatField.alias && __webpack_require__(71)(thisField.args, thatField.args);
	}
	...
	var GraphQLConsoleReporter = function () {
	  ...
	  GraphQLConsoleReporter.prototype.reportTime = function reportTime(name, ms) {
	    if (this._verbose && !this.quiet) {
	      var time = ms === 0 ? __webpack_require__(15).gray(' <1ms') : ms < 1000 ? __webpack_require__(15).blue(leftPad(5, ms + 'ms')) : __webpack_require__(15).red(Math.floor(ms / 10) / 100 + 's');
	      process.stdout.write('  ' + time + ' ' + __webpack_require__(15).gray(name) + '\n');
	    }
	  };

	  GraphQLConsoleReporter.prototype.reportError = function reportError(caughtLocation, error) {
	    if (!this._quiet) {
	      process.stdout.write(__webpack_require__(15).red('ERROR:\n' + error.message + '\n'));
	      if (this._verbose) {
	        var frames = error.stack.match(/^ {4}at .*$/gm);
	        if (frames) {
	          process.stdout.write(__webpack_require__(15).gray('From: ' + caughtLocation + '\n' + frames.join('\n') + '\n'));
	        }
	      }
	    }
	  };
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var GraphQLParser = function () {
	  ...
	  GraphQLParser.transform = function transform(schema, definition) {
	    ...
	    return __webpack_require__(6).run('GraphQLParser.transform', function () {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var getFragmentScope = __webpack_require__(32).getFragmentScope,
	    getRootScope = __webpack_require__(32).getRootScope;
	...
	function relayApplyFragmentArgumentTransform(context) {
	  var fragments = new (__webpack_require__(91))();
	...
	function hashArguments(args, scope) {
	  ...
	  return __webpack_require__(82)(printedArgs);
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var RelayCompilerCache = function () {
	  ...
	  function RelayCompilerCache(name, cacheBreaker) {
	    ...
	    var username = __webpack_require__(42).userInfo().username;
	    var cacheID = __webpack_require__(22).createHash('md5').update(cacheBreaker).update(username).digest('hex');
	    this._dir = __webpack_require__(5).join(__webpack_require__(42).tmpdir(), name + '-' + cacheID);
	    if (!__webpack_require__(2).existsSync(this._dir)) {
	      __webpack_require__(2).mkdirSync(this._dir);
	    }
	  }
	  ...
	  RelayCompilerCache.prototype.getOrCompute = function getOrCompute(key, compute) {
	    ...
	    return Profiler.run('RelayCompilerCache.getOrCompute', function () {
	      var cacheFile = __webpack_require__(5).join(_this._dir, key);
	      if (__webpack_require__(2).existsSync(cacheFile)) {
	        return JSON.parse(__webpack_require__(2).readFileSync(cacheFile, 'utf8'));
	      }
	      var value = compute();
	      __webpack_require__(2).writeFileSync(cacheFile, JSON.stringify(value), 'utf8');
	      return value;
	    });
	  };
	  ...
	  RelayFileWriter.prototype.writeAll = function writeAll() {
	    ...
	    return Profiler.asyncContext('RelayFileWriter.writeAll', (0, _asyncToGenerator3.default)(function* () {
	        ...
	        doc.definitions.forEach(function (def) {
	          if (def.name) {
	            definitionsMeta.set(def.name.value, {
	              dir: __webpack_require__(5).join(_this._config.baseDir, __webpack_require__(5).dirname(filePath)),
	              ast: def
	            });
	          }
	        });
	      ...
	      var getGeneratedDirectory = function getGeneratedDirectory(definitionName) {
	        ...
	        var generatedPath = __webpack_require__(5).join(getDefinitionMeta(definitionName).dir, '__generated__');
	      ...
	      var artifacts = __webpack_require__(40)(compilerContext, _this._config.compilerTransforms, _this._reporter);
	      ...
	      try {
	        yield Promise.all(artifacts.map((() => {
	          var _ref3 = (0, _asyncToGenerator3.default)(function* (node) {
	            ...
	            __webpack_require__(1)(typeNode, 'RelayFileWriter: did not compile types for: %s', node.name);
	            ...
	            var sourceHash = Profiler.run('hashGraphQL', function () {
	              return __webpack_require__(81)(__webpack_require__(4).print(getDefinitionMeta(node.name).ast));
	            });

	            yield __webpack_require__(85)(getGeneratedDirectory(node.name), node, formatModule, typeText, persistQuery, _this._config.platform, relayRuntimeModule, sourceHash, _this._config.extension);
	          });
	  ...
	  RelayFileWriter.prototype.writeCompleteQueryMap = function writeCompleteQueryMap(allOutputDirectories) {
	    ...
	    try {
	      ...
	      allOutputDirectories.forEach(function (d) {
	        __webpack_require__(2).readdirSync(d._dir).forEach(function (f) {
	          if (f.endsWith('.queryMap.json')) {
	            var singleQueryMap = JSON.parse(__webpack_require__(2).readFileSync(__webpack_require__(5).join(d._dir, f), 'utf8'));
	            queryMapJson = (0, _extends3['default'])({}, queryMapJson, singleQueryMap);
	          }
	        });
	      });

	      __webpack_require__(2).writeFileSync(queryMapFilePath, JSON.stringify(queryMapJson, null, 2));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var cache = new (__webpack_require__(55))('RelayFindGraphQLTags', 'v1');
	...
	function memoizedFind(tagFinder, text, baseDir, file, options) {
	  ...
	  return cache.getOrCompute(file.hash + (options.validateNames ? '1' : '0'), find.bind(null, tagFinder, text, __webpack_require__(5).join(baseDir, file.relPath), options));
	}
	...
	function find(tagFinder, text, absPath, _ref) {
	  ...
	  if (validateNames) {
	    var moduleName = __webpack_require__(78)(absPath);
	...
	function validateTemplate(_ref2, moduleName, filePath) {
	  ...
	  var ast = __webpack_require__(4).parse(new (__webpack_require__(4).Source)(template, filePath, sourceLocationOffset));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function getNodeIDFieldDefinition(schema) {
	  ...
	  if (isInterfaceType(iface)) {
	    ...
	    __webpack_require__(1)(fields.length === 1, 'RelayGenerateIDFieldTransform.getNodeIDFieldDefinition(): Expected ' + 'the Node interface to have one field of type `ID!`, but found %s.', fields.length === 0 ? 'none' : fields.map(function (field) {
	      return '`' + field.name + '`';
	    }).join(', '));
	    return fields[0];
	  }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var relaySchemaExtensions = [__webpack_require__(33).SCHEMA_EXTENSION, __webpack_require__(37).SCHEMA_EXTENSION];

	// Transforms applied to both operations and fragments for both reading and
	// writing from the store.
	var relayCommonTransforms = [__webpack_require__(33).transform, __webpack_require__(65).transform, __webpack_require__(37).transform, __webpack_require__(62).transform, __webpack_require__(35).transformOperations, __webpack_require__(60).transform];

	// Transforms applied to fragments used for reading data from a store
	var relayFragmentTransforms = [__webpack_require__(57).transform, FlattenTransform.transformWithOptions({ flattenAbstractTypes: true }), SkipRedundantNodesTransform.transform];

	// Transforms applied to queries/mutations/subscriptions that are used for
	// fetching data from the server and parsing those responses.
	var relayQueryTransforms = [__webpack_require__(35).transformSpreads, __webpack_require__(54).transform, SkipClientFieldTransform.transform, SkipUnreachableNodeTransform.transform];

	// Transforms applied to the code used to process a query response.
	var relayCodegenTransforms = [InlineFragmentsTransform.transform, FlattenTransform.transformWithOptions({ flattenAbstractTypes: true }), SkipRedundantNodesTransform.transform, __webpack_require__(36).transform, FilterDirectivesTransform.transform];

	// Transforms applied before printing the query sent to the server.
	var relayPrintTransforms = [FlattenTransform.transformWithOptions({}), __webpack_require__(36).transform, __webpack_require__(63).transform, FilterDirectivesTransform.transform, StripUnusedVariablesTransform.transform];
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = function (tagFinder) {
	  ...
	  function parseFile(baseDir, file) {
	    ...
	    __webpack_require__(1)(text.indexOf('graphql') >= 0, 'RelaySourceModuleParser: Files should be filtered before passed to the ' + 'parser, got unfiltered file `%s`.', file);
	    ...
	    memoizedTagFinder(text, baseDir, file, FIND_OPTIONS).forEach(function (template) {
	      ...
	      __webpack_require__(1)(ast.definitions.length, 'RelaySourceModuleParser: Expected GraphQL text to contain at least one ' + 'definition (fragment, mutation, query, subscription), got `%s`.', template);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var IMap = __webpack_require__(16).Map;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function skipUnreachableNodeTransform(context) {
	  ...
	  var nextContext = __webpack_require__(11).transform(context, {
	    Root: function Root(node) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function execFile(cmd, args) {
	  return new Promise(function (resolve, reject) {
	    __webpack_require__(89).execFile(cmd, args, function (err) {
	      if (err) {
	        reject(err);
	      } else {
	        resolve();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function stripUnusedVariablesTransform(context) {
	  ...
	  rootToVariables.forEach(function (variables, root) {
	    Array.from(__webpack_require__(14)(rootToFragmentSpreads.get(root), 'root ' + root + ' wasn\'t found in StripUnusedVariablesTransform')).forEach(function (spread) {
	  ...
	  return __webpack_require__(11).transform(context, {
	    Root: function Root(root) {
	      return transformRoot(context, root, __webpack_require__(14)(rootToVariables.get(root.name), 'root ' + root.name + ' wasn\'t found in StripUnusedVariablesTransform'));
	    },
	...
	function allVariablesReferencedInFragment(variablesMemo, fragment, fragmentToVariables, fragmentToFragmentSpreads) {
	  ...
	  if (!variables) {
	    var directVariables = __webpack_require__(14)(fragmentToVariables.get(fragment), 'fragment ' + fragment + ' wasn\'t found in StripUnusedVariablesTransform');
	    variables = Array.from(__webpack_require__(14)(fragmentToFragmentSpreads.get(fragment), 'fragment ' + fragment + ' wasn\'t found in StripUnusedVariablesTransform')).reduce(function (allVariables, fragmentSpread) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _crypto2 = _interopRequireDefault(__webpack_require__(22));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	let writeRelayGeneratedFile = (() => {
	  var _ref = (0, _asyncToGenerator3.default)(function* (codegenDir, generatedNode, formatModule, typeText, persistQuery, platform, relayRuntimeModule, sourceHash, extension) {
	    ...
	    var typeName = generatedNode.kind === __webpack_require__(10).FRAGMENT ? 'ConcreteFragment' : generatedNode.kind === __webpack_require__(10).REQUEST ? 'ConcreteRequest' : generatedNode.kind === __webpack_require__(10).BATCH_REQUEST ? 'ConcreteBatchRequest' : null;
	    var devOnlyProperties = {};

	    var docText = void 0;
	    if (generatedNode.kind === __webpack_require__(10).REQUEST) {
	      docText = generatedNode.text;
	    } else if (generatedNode.kind === __webpack_require__(10).BATCH_REQUEST) {
	    ...
	    if (generatedNode.kind === __webpack_require__(10).REQUEST || generatedNode.kind === __webpack_require__(10).BATCH_REQUEST) {
	      var oldHash = Profiler.run('RelayFileWriter:compareHash', function () {
	        var oldContent = codegenDir.read(filename);
	        // Hash the concrete node including the query text.
	        var hasher = __webpack_require__(22).createHash('md5');
	      ...
	      if (_persistQuery) {
	        switch (generatedNode.kind) {
	          case __webpack_require__(10).REQUEST:
	            var operationText = generatedNode.text;
	            devOnlyProperties.text = operationText;
	            var queryId = yield _persistQuery(__webpack_require__(23)(operationText));
	            queryMap = {};
	            ...
	            break;
	          case __webpack_require__(10).BATCH_REQUEST:
	            ...
	            generatedNode = (0, _extends3['default'])({}, generatedNode, {
	              requests: yield Promise.all(generatedNode.requests.map((() => {
	                var _ref2 = (0, _asyncToGenerator3.default)(function* (request) {
	                  ...
	                  var queryId = yield _persistQuery(__webpack_require__(23)(requestOperationText));
	                  queryMap = {};
	            ...
	            break;
	          case __webpack_require__(10).FRAGMENT:
	    ...
	    var devOnlyAssignments = __webpack_require__(73)('node', devOnlyProperties);
	    ...
	    var moduleText = formatModule({
	      ...
	      concreteText: __webpack_require__(72)(generatedNode),
